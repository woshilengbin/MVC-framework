...
/* GENERAL OPTIONS */
$config['handlers'] = array('file'); // valid handlers are file | new_relic | hipchat
...
*/
$config['file_logfile'] = APPPATH . 'logs/monolog-ci.log';
...
//  $config['hipchat_app_loglevel'] = Monolog\Logger::WARNING; //The minimum logging level at which this handler will be triggered
